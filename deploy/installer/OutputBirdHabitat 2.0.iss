...
#define ExtensionName "Output Bird Habitat"
...
AppId={{4A9BCF8D-0AFF-4B1E-B2D2-70C626371B85}
...
Source: {#BuildDir}\Landis.Extension.Output.BirdHabitat-v2.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "OutputBirdHabitat 2.0.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Output Bird Habitat"" "; WorkingDir: {#LandisPlugInDir}
