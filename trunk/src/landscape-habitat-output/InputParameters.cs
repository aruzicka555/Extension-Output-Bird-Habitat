...
namespace Landis.Extension.Output.LandscapeHabitat
{
        ...
        : IInputParameters
    {
        ...
        public string LocalVarMapFileNames
        {
            ...
            set {
                LandscapeHabitat.LocalMapFileNames.CheckTemplateVars(value);
        ...
        public string NeighborMapFileNames
        {
            ...
            set
            {
                LandscapeHabitat.NeighborMapFileNames.CheckTemplateVars(value);
        ...
        public string ClimateMapFileNames
        {
            ...
            set
            {
                LandscapeHabitat.ClimateMapFileNames.CheckTemplateVars(value);
        ...
        public string DistanceMapFileNames
        {
            ...
            set
            {
                LandscapeHabitat.DistanceMapFileNames.CheckTemplateVars(value);
        ...
        public string SpeciesMapFileNames
        {
            ...
            set
            {
                LandscapeHabitat.SpeciesMapFileNames.CheckTemplateVars(value);
